...
public class UserRepositoryImpl implements Repository<User> {
    ...
    private final static String SELECT_BY_USERNAME_SQL_STATEMENT = "SELECT * FROM ta.users WHERE username = ?";
    private final static String FIND_BY_EMAIL_SQL_STATEMENT = "SELECT * FROM ta.users WHERE email = ?";
    private final static String SELECT_ALL_STATEMENT = "SELECT * FROM ta.users";
    ...
    public List<User> getAll() {
        ...
        try (PreparedStatement preparedStatement = hikariDataSource.getConnection().prepareStatement(SELECT_ALL_STATEMENT)) {
